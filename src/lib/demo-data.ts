...
export const demoCampaign: Campaign = {
  ...
  recipient_email: 'prlsecy.forest@kerala.gov.in',
  cc_emails: ['emailkifa@gmail.com'],
  subject_ml: 'കേരള ഫോറസ്റ്റ് (ഭേദഗതി) ബിൽ 2024 — എന്റെ എതിർപ്പ്',
  subject_en: 'Objection to the Kerala Forest (Amendment) Bill, 2024',
  intro_ml:
