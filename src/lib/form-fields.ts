...
export type FieldMode = 'required' | 'optional' | 'disabled'
...
/** Generic fallback when a campaign has no form-field rows. Not campaign-specific copy. */
export const DEFAULT_FORM_FIELDS: Array<Omit<CampaignFormField, 'id' | 'campaign_id'>> = [
  ...
  { field_key: 'district', label_en: 'District', label_ml: 'ജില്ല', is_enabled: false, is_required: false, display_order: 5 },
  { field_key: 'local_body', label_en: 'Panchayat / Municipality', label_ml: 'പഞ്ചായത്ത് / മുനിസിപ്പാലിറ്റി', is_enabled: false, is_required: false, display_order: 6 },
  { field_key: 'village', label_en: 'Village', label_ml: 'വില്ലേജ്', is_enabled: false, is_required: false, display_order: 7 },
  { field_key: 'address', label_en: 'Address', label_ml: 'വിലാസം', is_enabled: false, is_required: false, display_order: 8 },
  { field_key: 'custom_message', label_en: 'Additional message', label_ml: 'അധിക സന്ദേശം', is_enabled: false, is_required: false, display_order: 9 },
]
